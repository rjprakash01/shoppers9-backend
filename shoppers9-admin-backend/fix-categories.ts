...
(async () => {
  try {
    ...
    categories.forEach(cat => {
      const parent = cat.parentCategory ? (cat.parentCategory as any).name : 'None';
    ...
    if (menClothingShirts) {
      ...
      console.log(`Parent: ${menClothingShirts.parentCategory ? (menClothingShirts.parentCategory as any).name : 'None'}`);
    } else {
