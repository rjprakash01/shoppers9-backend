...
import { ShoppingCart, User, Search, Menu, X, Heart, Bell, ChevronDown } from 'lucide-react';
          ...
          <div className="lg:hidden border-t border-gray-100 bg-white/95 backdrop-blur-md slide-up">
            <div className="px-4 pt-4 pb-6 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <button className="flex items-center space-x-3 w-full px-4 py-3 text-gray-700 hover:bg-red-50 hover:text-red-600 rounded-xl transition-all duration-300 font-medium">
                  <Heart className="h-5 w-5" />
                  <span>Wishlist</span>
                </button>
