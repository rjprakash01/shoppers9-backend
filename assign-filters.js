...
// Import models
const CategoryFilter = require('./shoppers9-admin-backend/src/models/CategoryFilter').default;
const Category = require('./shoppers9-admin-backend/src/models/Category').default;
const Filter = require('./shoppers9-admin-backend/src/models/Filter').default;
